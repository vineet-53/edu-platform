export const otpTemplate = (otpNumber, userEmail, websiteLink) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body>
  ...
  <div class="container">
    ...
    <p style="font-size: 0.9em">
      ...
      <br />
      <br />
      <strong>Thank you for using Edusync.</strong>
      <br />
      <br />
      Best regards,
      <br />
    ...
    <div class="footer">
      ...
      <p>
        For more information about Edusync and your account, visit
        <strong><a href=${websiteLink}>Website </a></strong>
      </p>
    </div>
  </div>
</body>
